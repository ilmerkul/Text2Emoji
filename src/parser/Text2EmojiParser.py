...
class Text2EmojiParser:
    ...
    """
    def __init__(self, pad_token: str, sos_token: str, eos_token: str, unk_token: str):
    ...
    def tokenize_text(self, row: dict[str, str], max_length: int) -> dict[str, list[str]]:
        """
        Tokenize text data.
        :param row: input dict[str, str] for processing
    ...
    def numericalize_data(self, row: dict[str, list[str]]) -> dict[str, list[int]]:
        """
